...
export default {
  ...
  innerTouchableBackgroundColor: "#1b1b1b",
  listItemHeight: 50,
  ...
  activeTab: platform === PLATFORM.IOS ? "#007aff" : "#1b1b1b",
  sTabBarActiveTextColor: "#007aff",
  tabBarActiveTextColor: platform === PLATFORM.IOS ? "#2874F0" : "#1b1b1b",
  tabActiveBgColor: platform === PLATFORM.IOS ? "#cde1f9" : "#3F51B5",

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? "#fff" : "#fff",
  toolbarDefaultBg: platform === PLATFORM.IOS ? "#1b1b1b" : "#1b1b1b",
  toolbarHeight: platform === PLATFORM.IOS ? 64 : 56,
  toolbarSearchIconSize: platform === PLATFORM.IOS ? 20 : 23,
  toolbarInputColor: platform === PLATFORM.IOS ? "#CECDD2" : "#1b1b1b",
  searchBarHeight: platform === PLATFORM.IOS ? 30 : 40,
  searchBarInputHeight: platform === PLATFORM.IOS ? 30 : 50,
  toolbarBtnTextColor: platform === PLATFORM.IOS ? "#007aff" : "#1b1b1b",
  ...
  segmentActiveBackgroundColor:
    platform === PLATFORM.IOS ? "#007aff" : "#1b1b1b",
  segmentTextColor: platform === PLATFORM.IOS ? "#007aff" : "#1b1b1b",
  segmentActiveTextColor: platform === PLATFORM.IOS ? "#1b1b1b" : "#3F51B5",
  segmentBorderColor: platform === PLATFORM.IOS ? "#007aff" : "#1b1b1b",
  ...
  topTabBarActiveTextColor: platform === PLATFORM.IOS ? "#007aff" : "#1b1b1b",
  topTabBarBorderColor: platform === PLATFORM.IOS ? "#a7a6ab" : "#1b1b1b",
  topTabBarActiveBorderColor: platform === PLATFORM.IOS ? "#007aff" : "#1b1b1b",
